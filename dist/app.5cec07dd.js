...
var UserForm = /*#__PURE__*/function () {
  function UserForm(parent, model) {
    ...
    _defineProperty(this, "onSetAgeClick", function () {
      _this.model.setRandomAge();
    });
    _defineProperty(this, "onSetNameClick", function () {
...
exports.User = User;
},{"./Model":"src/models/Model.ts","./Attributes":"src/models/Attributes.ts","./ApiSync":"src/models/ApiSync.ts","./Eventing":"src/models/Eventing.ts","./Collection":"src/models/Collection.ts"}],"src/app.ts":[function(require,module,exports) {
"use strict";
